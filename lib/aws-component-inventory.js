...
program
  ...
  .action(function(args) {
    if (!program.resource) {
      console.error("require -r option for windows command. see `aws-component-inventory linux -h`");
      process.exit(1);
    }
...
program
  ...
  .action(function(args) {
    if (!program.resource) {
      console.error("require -r option for windows command. see `aws-component-inventory windows -h`");
      process.exit(1);
    }
...
program
  ...
  .action(function(args) { readConfig(require("./commands/check-component.js"), args); });
